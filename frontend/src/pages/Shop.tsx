...
const Shop = () => {
    ...
    // Data — transparently backed by static data (Phase 0) or API (Phase 1+)
    ...
    const filteredProducts = productsPage?.data ?? [];
    ...
    return (
        <div className="min-h-screen flex flex-col section-warm-white">
            ...
            <main className="flex-1 container mx-auto px-6 py-12">
                ...
                <ErrorBoundary section="Products Grid">
                    {/* Loading State */}
                    {isLoading && (
                    ...
                    {isError && !isLoading && (
                        <div className="text-center py-20">
                            <h3 className="font-heading text-2xl text-luxury-black/60">Failed to load products.</h3>
                            <p className="font-ui text-sm text-luxury-black/50 mt-2">Please try refreshing the page.</p>
                        </div>
                    )}
                            ...
                            {filteredProducts.map((product, i) => (
                                ...
                                >
                                    <Link to={`/product/${product.id}`} className="relative block overflow-hidden aspect-square">
                                        ...
                                        {product.badge && (
                                            <div className="absolute top-3 right-3 bg-luxury-black text-warm-white text-xs font-ui px-2.5 py-1 rounded-full">
                                                {product.badge}
                                            </div>
                                        )}
